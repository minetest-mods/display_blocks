if enable_display_uranium == false then
	core.register_alias("display_blocks:uranium_dust", "technic:uranium_block")
	core.register_alias("display_blocks:uranium_block", "technic:uranium_block")
	core.register_alias("display_blocks:uranium_ore", "technic:mineral_uranium")
end
